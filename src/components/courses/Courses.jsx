  ...
  return (
    <div className='container py-14 md:py-24 bg-white'>
      <div className='text-center py-20'>
        <div className='text-orange-500 font-bold text-xl'>Our tutor subjects</div>
        <div className='text-gray-500 font-bold text-3xl'>Find Online Tutor in Any Subject</div>
      </div>
      <motion.div

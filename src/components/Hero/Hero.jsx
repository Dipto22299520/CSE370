      ...
      <div className='container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative bg-white'>
        <div className='flex flex-col justify-center py-14 md:pr-16 xl:pr-40 md:py-0'>
          <div className='text-center md:text-left space-y-6'>
            ...
            className='text-5xl font-bold lg:text-6xl leading-tight'>Find Your Perfect <span className='text-primary'>Tutor</span></motion.h1>
            <motion.p
            initial={{opacity :0, x:-100}}
            animate={{opacity:1,x:0}}
            transition={ {duration:0.5,delay:1.8}}
            className='text font-semibold'>We help you find perfetc tutor for 1-on-1 lessons. It is completely private</motion.p>
            <motion.div 
            initial={{opacity :0, x:-100}}
            animate={{opacity:1,x:0}}
